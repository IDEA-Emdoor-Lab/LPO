...
def build_pretraining_data_loader(dataset, consumed_samples):
    ...
    trainning_micro_bsz = args.micro_batch_size
    if args.train_mode == 'xpo':
        print(f'XPO reduce args.micro_batch_size to half: {trainning_micro_bsz} --> {trainning_micro_bsz // 2}')
        trainning_micro_bsz = trainning_micro_bsz // 2
    ...
    if args.dataloader_type == 'single':
        batch_sampler = MegatronPretrainingSampler(
            ...
            micro_batch_size=trainning_micro_bsz,
