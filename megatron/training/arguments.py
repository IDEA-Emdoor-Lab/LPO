...
def _add_xpo_args(parser):
    group = parser.add_argument_group(title='XPO Arguments')
    group.add_argument('--loss-type', type=str, required=False, default='lpo-ste',
                       choices=['sigmoid','hinge',
                                'ipo', 'kto_pair',
                                'lpo', 'lpo-r',
                                'lpo-ste', 'lpo-ste-dynamic'],
                       help='What type of XPO loss to use.')
    group.add_argument('--beta', type=float, default=0.2,
                       help='Hyper parameter Beta.')
    group.add_argument('--label-smoothing', type=float, default=0.0,
                       help='Hyper parameter Label smoothing.')
    group.add_argument('--gamma', type=float, default=5.0,
                       help='Hyper parameter gamma.')
    group.add_argument('--r1', type=float, default=1.0,
                       help='Hyper parameter r1.')
    group.add_argument('--r2', type=float, default=0.8,
                       help='Hyper parameter r2.')
    group.add_argument('--add-sft-loss', action="store_true", default=False,
                       help='Wheather add sft loss to xpo loss.')
    group.add_argument('--is-average', action="store_true", default=False,
                       help='Wheather average log-probs.')
