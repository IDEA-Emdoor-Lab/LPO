...
STEP=15000
date=20250618
SOURCE_CKPT_PATH=/cognitive_comp/ccnl_common_data/large/sft_audio_data/output/text/20250630/train/checkpoints_with_bug/checkpoint/xpo-mcore-qwen2.5-7B-lr-2e-7-minlr-1e-7-bs-6-gbs-24-seqlen-4096-pr-bf16-tp-2-pp-4-cp-1-ac-false-do-true-sp-true-ti-33000-wi-66
TARGET_CKPT_PATH=${SOURCE_CKPT_PATH}/iter_0004000_hf
TP=2
PP=4
PR=bf16
USE_TE=true
